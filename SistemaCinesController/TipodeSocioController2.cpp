#include "TipodeSocioController2.h"
using namespace SistemaCinesController;
using namespace System::IO;

TipodeSocioController2::TipodeSocioController2() {

}

List<TipodeSocio^>^ TipodeSocioController2::BuscarTipodeSocioxUsuarrio_Clase(String^ usuario, String^ claseSocio) {
...
List<TipodeSocio^>^ TipodeSocioController2::buscarAll() {
	List<TipodeSocio^>^ listaTipodeSocioEncontrados = gcnew List<TipodeSocio^>();
...
void TipodeSocioController2::eliminarTipodeSocio(int codigo) {
...
void TipodeSocioController2::escribirArchivo(List<TipodeSocio^>^ listaTipodeSocio) {
...
void TipodeSocioController2::agregarTipodeSocio(int codigo, String^ usuario, String^ contrasena, String^ fechaEmision, String^ fechaVencimiento, String^ claseSocio) {
	List<TipodeSocio^>^ listaTipodeSocio = buscarAll();
...
TipodeSocio^ TipodeSocioController2::buscartipodeSocioxCodigo(int codigo) {
...
void  TipodeSocioController2::actualizarTipodeSocio(TipodeSocio^ objTipodeSocio) {
	List<TipodeSocio^>^ listaTipodeSocio = buscarAll();
	for (int i = 0; i < listaTipodeSocio->Count; i++) {
