#include "ClienteController2.h"

using namespace SistemaCinesController;
using namespace System::IO;

ClienteController2::ClienteController2() {

}

List<Cliente^>^ ClienteController2::BuscarClientexnombre_ndocumento(String^ nombre, String^ ndocumento) {
...
List<Cliente^>^ ClienteController2::buscarAll() {
	List<Cliente^>^ listaClienteEncontrados = gcnew List<Cliente^>();
...
void ClienteController2:: eliminarCliente(int codigo) {
...
void ClienteController2::escribirArchivo(List<Cliente^>^ listaCliente) {
...
void ClienteController2::agregarCliente(int codigo, String^ nombre, String^ apellidoPaterno, String^ apellidoMaterno, String^ tipoDocumento, String^ nroDocumento, String^ correo, String^ celular) {
	List<Cliente^>^ listaCliente = buscarAll();
...
Cliente^ ClienteController2::buscarClientexCodigo(int codigo) {
...
void ClienteController2::actualizarCliente(Cliente^ objCliente) {
	List<Cliente^>^ listaCliente = buscarAll();
	for (int i = 0; i < listaCliente->Count; i++) {
