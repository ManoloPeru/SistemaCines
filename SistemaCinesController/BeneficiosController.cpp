#include "BeneficiosController.h"

using namespace SistemaCinesController;
using namespace System::IO;

BeneficiosController :: BeneficiosController() {

}

List<Beneficios^>^ BeneficiosController :: BuscarBeneficiosxCodigo (int codigo) {
...
List<Beneficios^>^ BeneficiosController::buscarAll() {
	List<Beneficios^>^ listaBeneficiosEncontrados = gcnew List<Beneficios^>();
	array <String^>^ lineas = File::ReadAllLines("beneficios.txt");
	String^ separadores = ";";
	for each (String ^ lineaBeneficio in lineas) {
...
void BeneficiosController::eliminarBeneficios(int codigo) {
...
void BeneficiosController::escribirArchivo(List<Beneficios^>^ listaBeneficios) {
...
void BeneficiosController::agregarBeneficio(int codigo, int puntos, String^ descuentos, String^ fechaInicio, String^ fechaFin, String^ beneficio1, String^ beneficio2, String^ beneficio3) {
	List<Beneficios^>^ listaBeneficios = buscarAll();
...
Beneficios^ BeneficiosController::BuscarBeneficiosxCodigos(int codigo) {
...
void BeneficiosController::actualizarBeneficios(Beneficios^ objBeneficio) {
	List<Beneficios^>^ listaBeneficios = buscarAll();
	for (int i = 0; i < listaBeneficios->Count; i++) {
