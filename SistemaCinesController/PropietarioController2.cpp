#include "PropietarioController2.h"

using namespace SistemaCinesController;
using namespace System::IO;

PropietarioController2::PropietarioController2() {

}

List<Propietario^>^ PropietarioController2::buscarAll() {
...
Propietario^ PropietarioController2::buscarPropietario() {
...
void PropietarioController2::escribirArchivo(List<Propietario^>^ listaPropietario) {
...
void PropietarioController2::actualizarPropietario(Propietario^ objPropietario) {
