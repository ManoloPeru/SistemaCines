...
List<Anuncio^>^ AnuncioController::buscarAnuncios( String^ tipo) {
...
List<Anuncio^>^ AnuncioController::buscarAll() {
	List<Anuncio^>^ listaAnunciosEncontrados = gcnew List<Anuncio^>();
	array<String^>^ lineas = File::ReadAllLines("anuncios.txt");
	String^ separadores = ";";
	for each (String ^ lineaAnuncio in lineas) {
...
void AnuncioController::eliminarAnuncio(int codigo) {
...
void AnuncioController::escribirArchivo(List<Anuncio^>^ listaAnuncios) {
...
void AnuncioController::agregarNuevoAnuncioAnuncio(int idAnuncio, String^ duracion, String^ tipo, String^ fechaInicio, String^ fechaFin, String^ contenido, int importe) {
...
Anuncio^ AnuncioController::buscarAnuncioxCodigo(int id) {
...
void AnuncioController::actualizarAnuncio(Anuncio^ objAnuncio) {
