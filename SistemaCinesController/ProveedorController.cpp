...
//clase :: metodo
List<Proveedor^>^ ProveedorController::BuscarProveedorxRazonSocial_RUC(String^ RazonSocial, String^ RUC) {
...
List<Proveedor^>^ ProveedorController::buscarAll() {
...
void ProveedorController::escribirArchivo(List<Proveedor^>^ listaProveedor) {
...
void ProveedorController::agregarProveedor(int codigo, String^ RazonSocial, String^ RUC, String^ producto, String^ telefono, String^ correo) {
	List<Proveedor^>^ listaProveedor = buscarAll();
...
Proveedor^ ProveedorController::BuscarProveedorxCodigo(int codigo) {
...
void ProveedorController::actualizarProveedor(Proveedor^ objProveedor) {
	List<Proveedor^>^ listaProveedor = buscarAll();
	for (int i = 0; i < listaProveedor->Count; i++) {
