...
List<Pelicula^>^ PeliculasController::buscarPelicula(String^ nombre, String^ genero) {
...
List<Pelicula^>^ PeliculasController::buscarAll() {
	List<Pelicula^>^ listaPeliculasEncontradas = gcnew List<Pelicula^>();
	array<String^>^ lineas = File::ReadAllLines("peliculas.txt");
	String^ separadores = ";";
	for each (String ^ lineaPelicula in lineas) {
...
void PeliculasController::eliminarPelicula(String^ nombre) {
...
void PeliculasController::escribirArchivo(List<Pelicula^>^ listaPeliculas) {
...
Pelicula^ PeliculasController::buscarPeliculaxCodigo(int codigo) {
...
void PeliculasController::actualizarPelicula(Pelicula^ objPelicula) {
...
void PeliculasController::agregarPelicula(int codigo, String^ nombre, String^ genero, String^ fechaestreno, String^ restriccion, String^ sinopsis, String^ duracion) {
	List<Pelicula^>^ listaPelicula = buscarAll();
