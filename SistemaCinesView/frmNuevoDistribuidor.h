...
namespace SistemaCinesView {
	...
	/// <summary>
	/// Resumen de frmNuevoDistribuidor
	/// </summary>
	public ref class frmNuevoDistribuidor : public System::Windows::Forms::Form
	{
	public:
		frmNuevoDistribuidor(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(287, 439);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(75, 23);
			this->button2->TabIndex = 5;
			this->button2->Text = L"Cancelar";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &frmNuevoDistribuidor::button2_Click);
			// 
			// button1
			// 
			this->button1->Location = System::Drawing::Point(139, 439);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(75, 23);
			this->button1->TabIndex = 4;
			this->button1->Text = L"Grabar";
			this->button1->UseVisualStyleBackColor = true;
			this->button1->Click += gcnew System::EventHandler(this, &frmNuevoDistribuidor::button1_Click);
			// 
			// groupBox1
			// 
			...
			this->groupBox1->Location = System::Drawing::Point(56, 24);
			...
			this->ClientSize = System::Drawing::Size(470, 489);
			this->Controls->Add(this->button2);
			this->Controls->Add(this->button1);
			this->Controls->Add(this->groupBox1);
			this->Name = L"frmNuevoDistribuidor";
			this->Text = L"frmNuevoDistribuidor";
			this->Load += gcnew System::EventHandler(this, &frmNuevoDistribuidor::frmNuevoDistribuidor_Load);
...
#pragma endregion
	private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {//GRABAR
		...
		objDistribuidorController->agregarDistribuidor( ruc,  contacto, razonSocial);
...
private: System::Void frmNuevoDistribuidor_Load(System::Object^ sender, System::EventArgs^ e) {
}
};
}
