...
namespace SistemaCinesView {
	...
	/// <summary>
	/// Resumen de frmReporteVentasComidas
	/// </summary>
	public ref class frmReporteVentasComidas : public System::Windows::Forms::Form
	{
	public:
		frmReporteVentasComidas(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->Location = System::Drawing::Point(77, 134);
			...
			this->label1->Text = L"Reporte de Ventas de Comidas";
			// 
			// frmReporteVentasComidas
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(949, 515);
			this->Controls->Add(this->label1);
			this->Controls->Add(this->dataGridView1);
			this->Name = L"frmReporteVentasComidas";
			this->Text = L"frmReporteVentasComidas";
			this->Load += gcnew System::EventHandler(this, &frmReporteVentasComidas::frmReporteVentasComidas_Load);
...
#pragma endregion
	private: System::Void frmReporteVentasComidas_Load(System::Object^ sender, System::EventArgs^ e) {
		ComprobanteController^ objComprobanteController = gcnew ComprobanteController();
		List<Comprobante^>^ listaReporte = objComprobanteController->buscarAllComidas();
