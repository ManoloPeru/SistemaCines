...
namespace SistemaCinesView {
	...
	/// <summary>
	/// Resumen de frmEditarAnuncio
	/// </summary>
	public ref class frmEditarAnuncio : public System::Windows::Forms::Form
	{
	public:
		frmEditarAnuncio(void)
		{
			InitializeComponent();
			this->objAnuncio = gcnew Anuncio();
			//
			//TODO: agregar código de constructor aquí
			//
		}
		frmEditarAnuncio(Anuncio^objAnuncio)
		{
			InitializeComponent();
			this->objAnuncio = objAnuncio;
			//
			//TODO: agregar código de constructor aquí
			//
		}
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button1->Location = System::Drawing::Point(547, 195);
			...
			this->button2->Location = System::Drawing::Point(547, 103);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(92, 39);
			this->button2->TabIndex = 50;
			this->button2->Text = L"Grabar";
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &frmEditarAnuncio::button2_Click);
			// 
			// groupBox1
			// 
			...
			this->groupBox1->Font = (gcnew System::Drawing::Font(L"Monospac821 BT", 7.8F, System::Drawing::FontStyle::Italic, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->groupBox1->Location = System::Drawing::Point(79, 37);
			...
			this->Name = L"frmEditarAnuncio";
			this->Text = L"frmEditarAnuncio";
			this->Load += gcnew System::EventHandler(this, &frmEditarAnuncio::frmEditarAnuncio_Load);
...
#pragma endregion
	private: System::Void frmEditarAnuncio_Load(System::Object^ sender, System::EventArgs^ e) {
		this->textBox1->Text = Convert::ToString(this->objAnuncio->idAnuncio);
		this->textBox2->Text = this->objAnuncio->duracion;
		this->textBox3->Text = this->objAnuncio->fechaInicio;
		this->comboBox1->Text = this->objAnuncio->tipo;
		this->textBox4->Text = this->objAnuncio->fechaFin;
		this->textBox5->Text = this->objAnuncio->contenido;
		this->textBox6->Text = Convert::ToString(this->objAnuncio->importe);
...
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	this->objAnuncio->duracion = duracion;
	this->objAnuncio->fechaInicio= fechaInicio;
	this->objAnuncio->tipo=tipo;
	this->objAnuncio->fechaFin= fechaFin;
	 this->objAnuncio->contenido= contenido;
	 this->objAnuncio->importe= importe;

	AnuncioController2^ objAnuncioController = gcnew AnuncioController2();
	objAnuncioController->actualizarAnuncio(this->objAnuncio);

	MessageBox::Show("Se ha editado el Anuncio de forma exitosa");
	this->Close();
}
};
}
