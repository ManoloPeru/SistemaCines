...
namespace SistemaCinesView {
	...
	/// <summary>
	/// Resumen de frmEditarNormaCine
	/// </summary>
	public ref class frmEditarNormaCine : public System::Windows::Forms::Form
	{
	public:
		frmEditarNormaCine(void)
		{
			InitializeComponent();
			this->objNormasCine = gcnew NormasCine();
			//
			//TODO: agregar código de constructor aquí
			//
		}

		frmEditarNormaCine(NormasCine^ objNormasCine)
		{
			InitializeComponent();
			this->objNormasCine = objNormasCine;
			//
			//TODO: agregar código de constructor aquí
			//
		}
	...
	private: NormasCine^ objNormasCine;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->groupBox1->Location = System::Drawing::Point(64, 63);
			...
			this->button2->Click += gcnew System::EventHandler(this, &frmEditarNormaCine::button2_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &frmEditarNormaCine::button1_Click);
			// 
			// richTextBox2
			// 
			...
			this->ClientSize = System::Drawing::Size(587, 681);
			this->Controls->Add(this->groupBox1);
			this->Name = L"frmEditarNormaCine";
			this->Text = L"frmEditarNormaCine";
			this->Load += gcnew System::EventHandler(this, &frmEditarNormaCine::frmEditarNormaCine_Load);
...
#pragma endregion
		private: System::Void frmEditarNormaCine_Load(System::Object^ sender, System::EventArgs^ e) {
			this->comboBox1->Text = this->objNormasCine->tipoNorma;
			this->richTextBox2->Text = this->objNormasCine->descripcion;
			this->textBox1->Text = this->objNormasCine->resolucionNormativa;
			this->richTextBox1->Text = this->objNormasCine->plandeAccion;
		}
...
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	this->objNormasCine->tipoNorma = tipoNorma;
	this->objNormasCine->descripcion = descripcion;
	this->objNormasCine->resolucionNormativa = resolucionNormativa;
	this->objNormasCine->plandeAccion = plandeAccion;
	NormasCineController2^ objNormasCineController = gcnew NormasCineController2();
	objNormasCineController->actualizarNorma(this->objNormasCine);
